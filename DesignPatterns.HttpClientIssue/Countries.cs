...
namespace DesignPatterns.HttpClientIssue
{
    /*
   ...
   */
    ...
    {       
        public static IEnumerable<ISOCountry> Countries => countryList;
    
        private class Country : ISOCountry
        {
        ...
        private static readonly IEnumerable<ISOCountry> countryList = new List<ISOCountry>
        {
